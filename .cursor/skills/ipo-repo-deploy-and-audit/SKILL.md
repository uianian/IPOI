...
# 服务器无管理员权限，所以暂时不考虑部署Docker（用于快速起 PostgreSQL / Redis，README推荐方式）
...
新建conda虚拟环境，注意 `requirements.txt` 里实际比 README 文档列出的多了
...
export IPO_LLM_API_KEY=""                 # 直接使用仓库中的key
export IPO_LLM_API_BASE="https://api.openai.com/v1"  # 与仓库中的配置保持一致
