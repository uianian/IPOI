...
FIELD_META: dict[str, dict[str, Any]] = {
    ...
    "PIPELINE_RISK": {
        "label": "核心产品/管线进度（18A）",
        "section": "隐性风险",
        "ideal": "核心产品临床阶段、授权引进、IP 权属（biotech/18a 才召回）",
        "prefer_roles": ["other", "discussion", "summary"],
        "prefer_cats": ["text", "table"],
        "gold_hint_pages": set(),
    },
    # deprecated: §3.4 归财务，legal 包不再产出
    "CASH_BURN_PRESSURE": {
        "label": "现金流消耗压力（已废弃·归财务）",
        "section": "隐性风险",
        "ideal": "（legal 包已移除；见财务 2.3/2.4）",
        "prefer_roles": ["summary", "discussion", "appendix"],
        "prefer_cats": ["text", "table"],
        "gold_hint_pages": {29, 31, 36, 360},
    },
    "PRE_IPO_VALUATION": {
        "label": "Pre-IPO估值与权利清理",
        "section": "隐性风险",
        "ideal": "投前/投后估值、融资轮次、上市前特殊权利清理",
        "prefer_roles": ["other", "summary", "discussion"],
        "prefer_cats": ["text", "table"],
